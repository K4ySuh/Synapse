"""Service regression tests for facade services."""
...
class FacadeProjectionTests(unittest.TestCase):
...
class FacadeCatalogTests(unittest.TestCase):
    def setUp(self) -> None:
...
class FacadeExecutionTests(unittest.TestCase):
    def setUp(self) -> None:
...
class FacadeResourceTests(unittest.TestCase):
    def setUp(self) -> None:
        self.tmp = TemporaryDirectory()
...
class FacadeResumeTests(unittest.TestCase):
