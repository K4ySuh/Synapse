    ...
    def _work_item(record: Mapping[str, Any], revision: int) -> ContextItem:
        ...
        return ContextItem(
            ...
            attributes={
                ...
                "dependencyPolicy": str(record.get("dependencyPolicy") or "success_required"),
                ...
                "blocker": dict(record.get("blocker") or {}),
                "storedStatus": str(record.get("storedStatus") or record.get("status") or "planned"),
